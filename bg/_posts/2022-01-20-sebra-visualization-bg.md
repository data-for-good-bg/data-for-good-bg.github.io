...
Изполвайки [приложението за визуализция](https://data-for-good.bg/sebra) може да разберете коя е институцията, която тегли най-много пари в брой или да видите как държавните медии или държавните висши училища изразходват своя бюджет. Нека го разгледаме в детаил.

# Какво е СЕБРА?

Системата за електронни бюджетни плащания СЕБРА представлява централизирана система за обслужване на сметки на бюджетни организации и бюджетни плащания. Бюджетните организации включени в СЕБРА управляват своите плащания в рамките на предварително зададените им лимити.
Изграждането на системата за извършване и контролиране на плащанията на бюджетните предприятия е по идея, дошла от Международния Валутен Фонд. Системата стартира на 19 февруари 2001 г. и цели подобряване на контрола над плащанията и повишаване на фискалната прозрачност.
На 19 февруари 2022 г. системата за електронни бюджетни плащания СЕБРА навършва 21 години.

# Приложиението за визуализация

## Видове визуализации

Приложението разполага с няколко раздела с визуализации.
Между тях се превключва чрез този панел:

![img.png](../../assets/img/sebra/sections.png)

### Обобщение

Раздел Обобщение е визуализация, която показва относитлното количество изхарчени средства по институции.
...
*Пример: Сравнене на разходите за 2021 г. на висшите училища и БАН (в синьо), на обществните медии (в жълто) и на народното събрание (в червено).*
...
* Когато са избрани, останлата част от визуализацията също се адаптира така че да отразява селекцията и данните които те представляват.
