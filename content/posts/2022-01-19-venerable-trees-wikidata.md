...
Той не само отбелязва възрастта и размерите на дърветата, 
...
<iframe style="width: 80vw; height: 50vh; border: none;" src="https://query.wikidata.org/embed.html#%23defaultView%3AMap%0Aselect%20%2a%20%7B%0A%20%20%3Fx%20wdt%3AP31%20wd%3AQ811534%20%3B%20%0A%20%20%20%20%20wdt%3AP625%20%3Fcoords%20%3B%20%0A%20%20%20%20%20wdt%3AP17%20wd%3AQ219%20%3B%0A%20%20%20%20%20wdt%3AP10241%20%3Fspecies%20.%0A%20%20SERVICE%20wikibase%3Alabel%20%7B%20bd%3AserviceParam%20wikibase%3Alanguage%20%22en%22.%0A%20%20%20%20%20%3Fx%20rdfs%3Alabel%20%3Flabel.%0A%20%20%20%20%20%3Fspecies%20rdfs%3Alabel%20%3Flayer.%0A%20%20%7D%0A%7D" referrerpolicy="origin" sandbox="allow-scripts allow-same-origin allow-popups" ></iframe>
...
Уикданни е част от Уики- екосистемата. 
Всеки ден хиляди потребители допринасят в нея. 
И вие можете да допринесете като например добавяте снимки на вековни дървета, които все още не са снимани. 

Изберете си някое на картата, намерете го. Направето му няколко хубави снимки и ги качете в [Общомедия](https://commons.wikimedia.org/), като добавите описание и най-вече връзка към обекта, който отговаря на дървото от картата. Така снимката ще стане част от все по-пълния и подробен масив от свързани отворени данни описващи България. 
